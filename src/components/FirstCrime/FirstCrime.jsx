...
import "./FirstCrime.css"
import { Link } from 'react-router-dom';

const FirstCrime = () => {
  return (
    <div className='FirstCrime'>
      <br />
      <br />
      <br />
      <br />
      <br />
      <br />
      <h2>Please Selelect the <a className='Type'>Type</a> of Crimes</h2>
      <div className="years">
        <div className="year">
          <h3>Crime Against Children</h3>
      ...
      <div className="years">
        ...
        <div className="year">
          <h3>Occurance of Cyber <br />Crime</h3>
        ...
        <div className="year">
          <h3>Details About Juveniles Arrested</h3>
      ...
      <div className="years">
        ...
        <div className="year">
          <h3>Offenders Known to the Victim (2013-2022)</h3>
